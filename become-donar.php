...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><strong>Become a Donor</Strong></li>
        </ol>
...
<div class="row">
<div class="col-lg-4 mb-4">
<center><div><input type="submit" name="submit" class="btn btn-primary" value="submit" style="cursor:pointer"></div></center>
</div>
